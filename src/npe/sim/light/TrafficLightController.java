/**
 * ***********************************************************
 * PROGRAM:     AussieTraffic
 * 
 * FILE:        TrafficLightController.java
 * 
 * HISTORY:
 * Date     Author          Description
 * ====     ======          ===========
 * 2/28/16  Jesse Anderson  Initial standardization
 *          (from code from Prof. C. Szabo at U of Adelaid)
 */
...
/************************************************************************
 * DESCRIPITION: Class TrafficLightController
 * Program that makes and controls the Traffic lights and their patterns.
 ************************************************************************/
public class 
TrafficLightController {
	...
	/** The duration of the north tce east right hand turn */
	 ...
	 * @param numTrafficLights Number of traffic lights the controller will control
	 */
	public 
	TrafficLightController(int numTrafficLights)   {
		//read the csv
	...
	//setDefaultsMM()
	//changeLightMM()
	//findTrafficLightInStateMM()
	//setDefaultStateDurationMM()
	//getJTableMM()
	//getNumStatesMM()
	//getTrafficLightDurationsMM()
	//CellRender()
	//TrafficLightModelMM()
	//isCellEditableMM()
	//addEditableStateMM()
	//totalDurationMM()
	//increaseDurationMM()
	//getTrafficLightRedDurationMM()
	//getTrafficLightYellowDurationMM()
	//getTrafficLightGreenDurationMM()
	//getSequenceMM()
	//updateSequenceMM()
	//addLaneMM()
	//changeStateMM()
	...
	//drawMM()
	//checkSequenceMM()
	//getPedestrianLightEventsMM()
	//setTrafficLightCoordsMM()
	//setPedestrianLightCoordsMM()
	//addPedestrianLanesMM()
	//addBoxMM()
	//getStateMM()
	//updateStateMM()
	//setDefaultSeqOneMM()
	//setDefaultSeqTwoMM()
	//setDefaultSeqThreeMM()
	//setDefaultSeqFourMM()
	//changeStateDurationMM()
	//getMaxDurationMM()
	//getMinDurationMM()
	//assertTrafficLightDurationsMM()
	//updateTrafficLightDurationsMM()
	//saveCsvMM()
	//saveDurationsMM()
	//setYellowDurationMM()
	...
	readCsv()  {
		...
		try {
			...
			try {
				...
				System.err.println("WARNING: Failed to close Buffered Reader");
			}//catch
		}//try 
		catch (IOException e){
	 ...
	 * Sets variables to default constants in this file.
	 */
	private void
	setDefaults() {
	 ...
	 */
	public int
	changeLight(int tid, TrafficLight.State state, int duration )  {
	...
	/**
	 * DESCRIPTION: findTrafficLightInState
	...
	findTrafficLightInState(int lightIndex, TrafficLight.State tlState)    {
	...
	}//findTrafficLightInState

	/** 
	 * DESCRIPTION: setDefaultStateDuration
	...
	/** 
	 * DESCRIPTION: getNumStates
	 * Get the number of states in the currently set sequence 
	 * */
	 ...
	 */
	private class 
	CellRender extends DefaultTableCellRenderer    {
		...
		/**
		 * DESCRIPTION: getTableCellRendererComponent 
		 * overriding getTable cell renderer
		 * This rendered will paint all cells with a light the appropriate colour
		 * It overrides the value of traffic light state cells so they don't display there string
		 */
		public Component 
	 ...
	 */
	private void 
	increaseDuration(TrafficLight light, TrafficLight.State state, int duration)   {
	...
	/**
	 * DESCRIPTION: getTrafficLightRedDuration
	 ...
	 */
	public int 
	getTrafficLightRedDuration(int selected)   {

		return trafficLight[selected].getRedDuration();

	}//getTrafficLightRedDuration

	/**
	 * DESCRIPTION: getTrafficLightYellowDuration
	...
	/**
	 * DESCRIPTION: draw
	 * The draw method, This will call draw on every traffic light and pedestrian light
	...
	/**
	 * DESCRIPTION: getPedestrianLightEvents
	...
	public Event[] 
		...
		//once we find ourselves a green man, find out the state in which the arrow turns green arrow turns yellow
	...
	/**
	 * DESCRIPTION: setTrafficLightCoords
	 ...
	 */
	public void 
	setTrafficLightCoords(int tid, int x, int y)    {

		trafficLight[tid].setX(x);
		trafficLight[tid].setY(y);

	}//setTrafficLightCoords

	public void 
	setPedestrianLightCoords(int pid, int x[], int y[]) {

		pedestrianLight[pid].setX(x);
		pedestrianLight[pid].setY(y);

	}//setPedestrianLightCoords

	/**
	 * DESCRIPTION: addPedestrianLanes
	 * Add pedestiran lanes to a traffic light
	 * @param road The road with the pedestrian lanes  on it
	 */
	public void 
	addPedestrianLanes(Road road)   {
	...
	/**
	 * DESCRIPTION: setDefaultSeqOne
	 *  Set the default states lengths of sequence 1 
	 */
	private int 
	setDefaultSeqOne(int firstState)    {
	...
	/** 
	 * DESCRIPTION: setDefaultSeqTwo
	 * Set the default states lengths of sequence 1 
	 */
	private int 
	setDefaultSeqTwo(int firstState)    {
	...
	/** 
	 * DESCRIPTION: setDefaultSeqThree
	 * Set the default states lengths of sequence 1
	 */
	private int 
	setDefaultSeqThree(int firstState)  {
	...
	/**
	 * DESCRIPTION SetDefaultSeqFour
	 *  Set the default states lengths of sequence 1 
	 */
	private int 
	setDefaultSeqFour(int firstState)   {
	...
	/**
	 * DESCRIPTION: changeStateDuration
	 * Changes the states duration
	 */
	public int
	changeStateDuration(int sid, int duration)  {
	...
	/** 
	 * DESCRIPTION: asserttrafficLightDurations
	...
	/**
	 * DESCRIPTION: updateTrafficLightDurations
	 ...
	 */
	private void 
	updateTrafficLightDurations(State state, int durationDifference)    {
	...
	/**
	 * DESCRIPTION: setYellowDuration
	 * Sets the yellow duration
	 */
	public boolean 
	setYellowDuration(int duration) {
...
//end TrafficLightController.java
